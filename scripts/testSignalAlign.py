...
class signalAlign_alignment_test(unittest.TestCase):
    def check_alignments(self, true_alignments, reads, reference):
        ...
        test_alignments = glob.glob(test_temp_dir + "tempFiles_alignment/*.tsv")
